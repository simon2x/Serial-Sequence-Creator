...
class FloatCompare(wx.Dialog):
    ...
    def __init__(self, parent, variables):
        ...
        grid3.Add(self.spin_decimal, pos=(row,1), flag=wx.ALL|wx.EXPAND, border=2)
    ...
    def SetValue(self, data):
        ...
        self.spin_decimal.SetValue(param_dict["decimal"])
    ...
    def GetValue(self):
        ...
        data = [("var1", var1),
                ...
                ("decimal", str(self.spin_decimal.GetValue()))]
                
        data = {"action":"Float Compare", 
                "parameters":str(data)}
